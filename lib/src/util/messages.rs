...
impl MessageText for MessageKind {
    fn text<'a>(&'a self) -> Option<String> {
        match self {
            ...
            MessageKind::Invoice { .. } => None,
            MessageKind::SuccessfulPayment { .. } => None,
            MessageKind::RefundedPayment { .. } => None,
            MessageKind::Gift { .. } => None,
            MessageKind::UniqueGift { .. } => None,
            MessageKind::GiftUpgradeSent { .. } => None,
            MessageKind::PaidMessagePriceChanged { .. } => None,
            MessageKind::Checklist { .. } => None,
            MessageKind::ChecklistTasksDone { .. } => None,
            MessageKind::ChecklistTasksAdded { .. } => None,
            MessageKind::ConnectedWebsite { data } => Some(data.to_owned()),
            MessageKind::ChatOwnerLeft { .. } => None,
            MessageKind::ChatOwnerChanged { .. } => None,
            MessageKind::DirectMessagePriceChanged { .. } => None,
            MessageKind::SuggestedPostApproved { .. } => None,
            MessageKind::SuggestedPostApprovalFailed { .. } => None,
            MessageKind::SuggestedPostDeclined { .. } => None,
            MessageKind::SuggestedPostPaid { .. } => None,
            MessageKind::SuggestedPostRefunded { .. } => None,
