...
impl InlineQueryResultArticle {
    ...
    pub fn thumbnail_url<T: Into<String>>(&mut self, thumbnail_url: T) -> &mut Self {
        self.thumbnail_url = Some(thumbnail_url.into());
        self
    }

    pub fn thumbnail_width<T: Into<Integer>>(&mut self, thumbnail_width: T) -> &mut Self {
        self.thumbnail_width = Some(thumbnail_width.into());
        self
    }

    pub fn thumbnail_height<T: Into<Integer>>(&mut self, thumbnail_height: T) -> &mut Self {
